...
archived. v0.4 J1–J3, Q1, P1, P2, P3, P3a, P3b, and P4 are implemented and
archived under `plans/v0.4/`; P5 is active and the remaining v0.4 product tasks
in `PLAN.md` require approval.
