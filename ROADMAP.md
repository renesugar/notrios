...
`PLAN.md` holds the active plan derived from this roadmap: 9 items, 0 complete, 1 in progress, 7 not started, 1 deferred.

Started and unfinished: I1. What remains in each is in the plan's own Progress section.
