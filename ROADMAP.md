...
`PLAN.md` holds the active plan derived from this roadmap: 5 items, 4 complete, 1 in progress, 0 not started, 0 deferred.

Started and unfinished: E5. What remains in each is in the plan's own Progress section.
