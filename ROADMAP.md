...
archived. v0.4 J1–J3, Q1, P1, P2, P3, and P3a are implemented; P3b (packed
object layout) is next, and it plus the remaining v0.4 product tasks in
`PLAN.md` require approval.
