...
`PLAN.md` holds the active plan derived from this roadmap: 23 items, 14 complete, 2 in progress, 7 not started, 0 deferred.

Started and unfinished: J7, J23. What remains in each is in the plan's own Progress section.
