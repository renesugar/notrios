...
`PLAN.md` holds the active plan derived from this roadmap: 24 items, 17 complete, 1 in progress, 6 not started, 0 deferred.

Started and unfinished: J22. What remains in each is in the plan's own Progress section.
