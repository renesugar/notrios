...
`PLAN.md` holds the active plan derived from this roadmap: 26 items, 19 complete, 1 in progress, 6 not started, 0 deferred.

Started and unfinished: J26. What remains in each is in the plan's own Progress section.
