...
`PLAN.md` holds the active plan derived from this roadmap: 23 items, 15 complete, 1 in progress, 7 not started, 0 deferred.

Started and unfinished: J7. What remains in each is in the plan's own Progress section.
