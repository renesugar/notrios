...
`PLAN.md` holds the active plan derived from this roadmap: 4 items, 2 complete, 1 in progress, 1 not started, 0 deferred.

Started and unfinished: E3. What remains in each is in the plan's own Progress section.
