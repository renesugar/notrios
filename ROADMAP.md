...
`PLAN.md` holds the active plan derived from this roadmap: 30 items, 20 complete, 1 in progress, 9 not started, 0 deferred.

Started and unfinished: J8. What remains in each is in the plan's own Progress section.
