...
`PLAN.md` holds the active plan derived from this roadmap: 24 items, 16 complete, 1 in progress, 7 not started, 0 deferred.

Started and unfinished: J24. What remains in each is in the plan's own Progress section.
