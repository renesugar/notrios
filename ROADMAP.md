...
`PLAN.md` holds the active plan derived from this roadmap: 12 items, 3 complete, 1 in progress, 8 not started, 0 deferred.

Started and unfinished: J12. What remains in each is in the plan's own Progress section.
