...
`PLAN.md` holds the active plan derived from this roadmap: 18 items, 8 complete, 2 in progress, 8 not started, 0 deferred.

Started and unfinished: J17, J18. What remains in each is in the plan's own Progress section.
