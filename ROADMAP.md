...
`PLAN.md` holds the active plan derived from this roadmap: 20 items, 12 complete, 1 in progress, 7 not started, 0 deferred.

Started and unfinished: J20. What remains in each is in the plan's own Progress section.
