// Package xdelta is an investigation-only pure-Go delta prototype.
//
...
// Notrios from the published algorithm and RFC 3284; it is not production sync
// code and is not a line-by-line translation of Subversion.
package xdelta
...
// Limits bounds every allocation and work unit performed by the prototype.
...
// DefaultLimits are deliberately small enough for an investigation harness.
// G2, not this prototype, owns production numeric limits.
