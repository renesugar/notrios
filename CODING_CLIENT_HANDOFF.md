...
## v0.8 package snapshots — completed 2026-09-09

Every v0.8 slice has a handoff ZIP in `/home/renes/evidence/notrios`. The table
is generated by `performance/v0.8e/build_manifest.py` from the archives
themselves and checked by `make validate`, because a table maintained by hand is
a table that stops being true — which is how the four rows that used to stand
here survived thirty-one slices closing without one.

| Slice | Commit | Bytes | Entries | SHA-256 (first 16) | Taken |
| --- | --- | --- | --- | --- | --- |
| H0 | `e164aeb` | 5,334,539 | 1,778 | `5b131883de2376bd` | at close |
| H1 | `fa3803c` | 8,048,849 | 1,810 | `202266b5d7697be7` | v0.8e, replacing an earlier one |
| H2a | `af37c4c` | 8,097,769 | 1,839 | `1ccad5458d57bee0` | v0.8e, replacing an earlier one |
| H2 | `e69419c` | 9,033,391 | 1,948 | `ce265b2a7d23f742` | v0.8e, replacing an earlier one |
| H2b | `e4f4432` | 8,107,410 | 1,842 | `606401536d3e1131` | v0.8e, replacing an earlier one |
| H3 | `97652f1` | 9,090,345 | 1,969 | `c120f577aaafb9ba` | v0.8e, replacing an earlier one |
| H4 | `693b672` | 9,208,812 | 1,998 | `1bf460aee1d7fc39` | at close |
| H4a | `036ba0c` | 9,183,748 | 1,991 | `fef0c36ab82abcd0` | v0.8e |
| H4b | `e58abf6` | 9,206,795 | 1,994 | `416807fdd5a6ffd7` | v0.8e |
| H5 | `3ec1ab3` | 9,234,737 | 1,996 | `656f2992f131519c` | v0.8e |
| H6a | `57b2a71` | 9,248,848 | 2,003 | `ecd6374593087010` | v0.8e |
| H6 | `3abdbf7` | 11,349,036 | 2,049 | `0ed958344f956601` | v0.8e |
| H8 | `a3490aa` | 11,360,058 | 2,053 | `2dd37fb578a374c7` | v0.8e |
| H14 | `1c8d577` | 18,068,134 | 2,196 | `f0efff10a7b7ec09` | v0.8e |
| H7 | `f544b98` | 9,260,333 | 2,008 | `9ec7551400ee7d3f` | v0.8e |
| H9 | `f0672d9` | 18,217,674 | 2,235 | `3fa64d5afcace994` | v0.8e |
| H10 | `b265ada` | 24,816,497 | 2,315 | `55a1d6ab90d49013` | v0.8e |
| H11 | `8c7017c` | 24,789,162 | 2,304 | `27cb714b67a0e742` | v0.8e |
| H12 | `baf6e4b` | 24,047,222 | 2,290 | `eb192a55fe45d0cf` | v0.8e |
| H15 | `fde811e` | 24,046,003 | 2,290 | `97833b795fd41bbf` | v0.8e |
| H16 | `b69b653` | 18,214,502 | 2,235 | `2cdfd0f0b94872fe` | v0.8e |
| H17 | `fa362b3` | 18,251,142 | 2,239 | `abe7ac0ac162d9f5` | v0.8e |
| H18 | `f79c956` | 24,046,748 | 2,290 | `ca9acc005d7e1e1a` | v0.8e |
| H19 | `cb76c7f` | 18,204,982 | 2,232 | `c05dc00a5a0db983` | v0.8e |
| H13 | `10e7077` | 24,945,579 | 2,316 | `8fc22b236266ba0e` | v0.8e, replacing an earlier one |
| H20 | `fa25182` | 18,208,254 | 2,233 | `3a95d434c4b6ad9f` | v0.8e |
| H21 | `49e4ad0` | 18,175,957 | 2,227 | `417a7639a47d1f5f` | v0.8e |
| H22 | `f2df4b3` | 18,157,658 | 2,224 | `963925a48c9a410c` | v0.8e |
| H23 | `5aca5ea` | 18,148,631 | 2,222 | `4dba8109fded5fef` | v0.8e |
| H24 | `faf9bd6` | 18,164,235 | 2,224 | `a14b5e145ede53ec` | v0.8e |
| H25 | `677ca1f` | 18,181,073 | 2,228 | `6527e546fa773fb1` | v0.8e |
| H26 | `b4fd8f9` | 18,196,292 | 2,230 | `0d4f747f7929a33f` | v0.8e |
| H27 | `c836eb5` | 18,238,244 | 2,237 | `f33fee8dc66fdff9` | v0.8e |
| H28 | `73f605c` | 18,785,532 | 2,244 | `f110d0e3996ef652` | v0.8e |
| H29 | `391cdd5` | 24,772,535 | 2,298 | `0bea90db3f0c21fd` | v0.8e |

**Only two were taken when their slice closed.** Packaging ran per slice through
H4 and then stopped, and nothing noticed for the rest of the milestone.
33 archives were built retroactively in **v0.8e**, each from its own
close-out commit in a disposable `git worktree` so the live checkout was never
touched, and each verified byte-identical to that commit's tree by
`performance/v0.8e/verify_archive.py`. `performance/v0.8e/CLOSEOUTS.json` records
how every commit was identified and why.

**What "retroactively" costs, said plainly.** An archive built in v0.8e has a
file timestamp from v0.8e. Nothing about the file attests when the work in it was
done; what the reserve's OpenPGP signature and RFC 3161 timestamp attest is when
the archive was *sealed*, and v0.8e seals before the first GitHub push so that
the sealing provably precedes disclosure. No row above claims more than that.

**6 of them replace an archive that
should not be sealed.** Five — H1, H2a, H2b, H2 and H3 — carried the 11 MB
`notrioslib` ELF that the 2026-09-01 rewrite removed from git, and today's
`scripts/check_release_zip.py` refuses all five; H1 fell from 15.3 MB to 8.0 MB
when it went. Their trees were faithful, and testing them proved the old-to-new
SHA mapping below is correct. The sixth, H13's, matched no commit at all: it was
built from the working tree while `030ef2d` was HEAD and H13's own changes were
uncommitted, so its filename asserted a commit whose tree it did not carry.

**The superseded files were not deleted.** Each is named in the manifest entry
that replaces it. Removing evidence is the repository owner's decision, and it
belongs before the reserve is sealed rather than after.
