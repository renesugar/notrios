...
Implement `PLAN.md` task **H5 (exact-hash dedup reports and perceptual-hash hooks)**; work one task at a time and ask the user before starting the next. The GitHub push itself is the user's step.
