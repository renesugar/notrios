...
**Current milestone: v1.0.** 19 items: 9 complete, 1 in progress, 9 not started, 0 deferred. Item by item, with what each one proved and what it left owed, in [`PLAN.md`](PLAN.md).
