...
The v0.1 through v0.6 milestones are complete. v0.7 G0's threat model and G1's
representative revision/delta/merge workload are complete; the new pure-Go
xdelta/VCDIFF feasibility investigation G1a is next and unapproved
