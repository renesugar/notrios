...
- Current milestone: v0.5 editing, blocks, and graph UX — **in progress**.
  ...
  editor link intelligence (E5), and the CodeMirror decision (E6 — stay) are
  complete and archived under `plans/v0.5/`; the remaining tasks (query blocks,
...
`performance/v0.5-e6/`. See `PACKAGING.md`,
