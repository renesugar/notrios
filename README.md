...
**Current milestone: v1.0.** 34 items: 24 complete, 0 in progress, 10 not started, 0 deferred. Item by item, with what each one proved and what it left owed, in [`PLAN.md`](PLAN.md).
