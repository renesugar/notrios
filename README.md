...
The v0.1 through v0.6 milestones are complete. v0.7 G0-G14c are complete through
...
while retaining semantic archive-v2; G14d is next and unapproved — see
[`PLAN.md`](PLAN.md) and
...
- **v0.7 (in progress) — native synchronization.** G0-G2 completed the threat,
  ...
  `snapshot create|verify` representation and admission boundary. G14d-G14e
  still block G15: integrate restore/catch-up and repeat
