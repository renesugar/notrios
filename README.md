...
- Current milestone: v0.5 editing, blocks, and graph UX — **in progress**.
  ...
  bounded graph traversal with shortest paths and an orphan/hub report (E4), and
  editor link intelligence (E5) are complete and archived under `plans/v0.5/`;
  the remaining tasks (the CodeMirror decision, query blocks, organizer UX, and
...
`performance/v0.5-e2/`, `performance/v0.5-e4/`, and `performance/v0.5-e5/`.
See `PACKAGING.md`,
