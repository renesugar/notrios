...
**Current milestone: v1.0.** 24 items: 17 complete, 1 in progress, 6 not started, 0 deferred. Item by item, with what each one proved and what it left owed, in [`PLAN.md`](PLAN.md).
