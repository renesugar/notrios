...
**Current milestone: v1.0.** 35 items: 30 complete, 0 in progress, 5 not started, 0 deferred. Item by item, with what each one proved and what it left owed, in [`PLAN.md`](PLAN.md).
