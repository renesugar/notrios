...
**Current milestone: v1.0.** 14 items: 5 complete, 1 in progress, 8 not started, 0 deferred. Item by item, with what each one proved and what it left owed, in [`PLAN.md`](PLAN.md).
