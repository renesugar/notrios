...
**Current milestone: v1.0.** 37 items: 32 complete, 0 in progress, 5 not started, 0 deferred. Item by item, with what each one proved and what it left owed, in [`PLAN.md`](PLAN.md).
