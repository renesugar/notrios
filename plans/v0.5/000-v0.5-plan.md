...
Status: **complete on 2026-08-06, archived. Drafted 2026-08-05 from
`ROADMAP.md` after v0.4 completed; all thirteen slices (E1, E1a, E1b, E2, E3, E4,
E5, E6, E6a, E6b, E7, E8, E9) shipped. E6a and E6b were added mid-milestone from
what E6 measured and from a user question about math rendering.**

This is the archived copy of the v0.5 plan as it stood at completion. The live
`PLAN.md` holds the next milestone.
