...
Status: **Complete. Planned from `ROADMAP.md` on 2026-09-09 after v0.8e closed and
finished on 2026-09-10. Ten items: nine complete, one deferred. Product version
is 0.8.0 and the canonical database schema is v27 — v0.9 hardened what v0.8
built and added no migration. The Wails v3 migration is the deferred item, and
it is deferred to post-v1.0. Merged to `main` as pull request #8; the evidence is
in reserve volumes NTR-EV-0002 through NTR-EV-0004.**
