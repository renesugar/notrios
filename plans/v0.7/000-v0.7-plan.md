...
Status: **G0-G20 are complete through 2026-08-31. Product version is 0.7.0 and
...
attested offline backup/revocation readiness. The
...
## G20. Full convergence, disaster recovery, security, and release wrap-up — complete
...
- **What is the v0.7 version/schema release number? — Non-blocking until this
  ...
  **Resolved 2026-08-31:** selected `0.7.0` with canonical schema v27 and
  migrations v19-v27. The default was accepted without another migration.

**Outcome (2026-08-31).** Product 0.7.0/schema v27 passed the exact convergence,
directory/REST carrier, recovery, retention, lazy-resource, conflict/fault,
abuse, upgrade, documentation, dependency-license, and release-package matrix.
The complete standard security scan's six validated findings and one finite
static correction cycle are remediated; listener/TLS/browser/body boundaries
and rooted/bounded carrier and legacy-archive access have focused regressions.
Frozen G8/G14e/G17 aggregate evidence was revalidated without rereading the
private corpus. Evidence is `performance/v0.7-g20/`; archive:
...
| Release version/schema bookkeeping | G20 | Resolved 2026-08-31: product 0.7.0, schema v27, v19-v27 migration sequence |

G0-G20 are complete and the production physical restore/catch-up, durable
...
future GitHub push. v0.7 is closed at product 0.7.0/schema v27. The next plan
is derived from the v0.8 roadmap and begins only after explicit user approval.
