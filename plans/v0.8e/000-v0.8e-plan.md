...
Status: **Complete. Planned from `ROADMAP.md` on 2026-09-09 after v0.8 closed at
product 0.8.0 / schema v27, and closed the same day. Five items, five complete.
It wrote no product code and changed no product behaviour; it produced the
thirty-two missing handoff archives, three sealed reserve volumes, two new
structural validators and one gate. The GitHub push opens v0.9.**
