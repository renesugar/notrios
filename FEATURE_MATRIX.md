...
| Native record-level sync | Implemented through safe retention (v0.7 G17) | sync service/UI | Transactional change log, contiguous state vectors, deterministic merge, encrypted directory/REST carriers, lazy resources, physical catch-up, schema-v26 durable jobs, Sync Center, and schema-v27 signed retirement plus acknowledgement/snapshot-gated retention are live. Blocking G17a-G17b next backfill the historical evidence manifest/signatures/timestamps and external ISO reserve before any push; G18 then owns the portability handoff, followed by G18a-G18g documentation integrity/site work, G19 compatibility, and G20 release acceptance. |
