...
| Source-adjacent documentation anchors and truth grades | Planned v0.7 G18a/G18c/G18f | documentation tooling | Go and TS/TSX user/API fragments will map to implementing declarations and report executed, generated, claimed, and unverified coverage. Deterministic audit/freshness gates CI; calibrated blind-explanation contradiction review remains advisory. |
