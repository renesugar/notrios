...
| Native record-level sync | Implemented through safe retention (v0.7 G17) | sync service/UI | Transactional change log, contiguous state vectors, deterministic merge, encrypted directory/REST carriers, lazy resources, physical catch-up, schema-v26 durable jobs, Sync Center, and schema-v27 signed retirement plus acknowledgement/snapshot-gated retention are live. G17a-G17b completed the evidence-preservation contract, curated signature/timestamp backfill, immutable ISO reserve, and finite outer catalog; the checked-in verifier gates every future push. G18 next owns the portability handoff, followed by G18a-G18g documentation integrity/site work, G19 compatibility, and G20 release acceptance. |
